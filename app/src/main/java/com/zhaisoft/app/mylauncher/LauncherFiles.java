...
public class LauncherFiles {
    ...
    public static final String OLD_SHARED_PREFERENCES_KEY = "com.zhaisoft.app.mylauncher.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.zhaisoft.app.mylauncher.managedusers.prefs";
